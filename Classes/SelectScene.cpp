...
bool SelectScene::init()
{
	...
	pPageView->addEventListener(
		static_cast<ScrollView::ccScrollViewCallback>(
			[=](Ref* pSender, ScrollView::EventType type)
			{
	...
	pStartBtn->addClickEventListener(
		[=](Ref* pSender)
		{
			auto gameMapScene = GameMapScene::getInstance();
